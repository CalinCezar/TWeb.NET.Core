...
namespace Forums.Web.Controllers
{
    public class ProfileController : Controller
    {
        ...
        public ProfileController(IUser user, IWebHostEnvironment environment)
        {
            _user = user;
        ...
        public async Task<IActionResult> DeleteUser()
        {
            ...
            var userData = await _user.GetUserDataActionAsync(user.Id);
            ...
            GeneralResp resp = await _user.DeleteUserActionAsync(user.Id);
            if (resp.Status)
            {
                HttpContext.Session.Clear();
                HttpContext.Session.Remove("LoginStatus");
        ...
        [HttpPost]
        public async Task<IActionResult> EditProfile(UserData data)
        {
            var user = HttpContext.GetMySessionObject();
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var userByID = await _user.GetUserDataActionAsync(user.Id);
